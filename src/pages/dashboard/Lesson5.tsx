...
const safetyQuestions = [
  {
    question: "Which should you never casually paste into a chatbot?",
    options: [
  ...
  {
    question: "Which is an ethical use of AI for studying?",
    options: [
  ...
  {
    question: "What is the safest rule for high-risk information?",
    options: [
      "AI is always enough.",
...
function Lesson5() {
  ...
  const finalScore = useMemo(
    () =>
      safetyQuestions.reduce(
        (score, question, index) =>
          score +
          (finalAnswers[index] === question.answer ? 1 : 0),
        0
      ),
    [finalAnswers]
  );
  ...
  const checkScenarioAnswer = (questionIndex: number) => {
    setCheckedScenarios((current) =>
      current.includes(questionIndex)
        ? current
        : [...current, questionIndex]
    );
      ...
      case 1:
        return (
          <>
            ...
            <h2>What does AI safety actually mean?</h2>
            ...
            <div className="lesson5-principle">
              <span>🛡️</span>
              <div>
                <strong>CURIO Safety Principle</strong>
                <p>
                  <b>Think → Protect → Verify → Use responsibly.</b>
                </p>
              </div>
            </div>
            ...
            <div className="lesson5-tip">
              <strong>Safety is a habit, not a button.</strong>
              <p>
        ...
        return (
          <>
            ...
            <div className="lesson5-information-grid">
              <article className="danger">
                ...
                <ul>
                  ...
                  <li>Private authentication information</li>
                </ul>
              </article>
              ...
              <article className="careful">
                ...
                <ul>
                  ...
                  <li>Family or school details</li>
                </ul>
              </article>

              <article className="safer">
                <span>🟢</span>
                <strong>Usually safer to discuss</strong>
                <ul>
                  <li>General concepts</li>
                  <li>Public information</li>
                  <li>Fictional examples</li>
                  <li>Generic study questions</li>
                  <li>De-identified examples</li>
                  <li>Practice data</li>
                </ul>
              </article>
            </div>
            ...
            <div className="lesson5-rule-box">
              <span>💡</span>
              <div>
                <strong>The “Does AI need this?” test</strong>
                <p>
      ...
      case 4:
        return (
          <>
            ...
            <h2>What does it mean to use AI ethically? ⚖️</h2>
            ...
            <div className="lesson5-ethics-grid">
              ...
              <article>
                <span>⚠️</span>
                <strong>Think about harm</strong>
                <p>
              ...
              <article>
                <span>🧠</span>
                <strong>Keep human judgement</strong>
                <p>
            ...
            <div className="lesson5-pro-con">
              <div>
                <strong>🟢 Responsible use can help</strong>
                <ul>
                  <li>Learn faster</li>
              ...
              <div>
                <strong>🔴 Irresponsible use can harm</strong>
                <ul>
                  <li>Spread misinformation</li>
                  <li>Expose private information</li>
                  <li>Enable deception</li>
                  <li>Damage someone's reputation</li>
                  <li>Create unfair or harmful outcomes</li>
                </ul>
              </div>
            </div>

            <div className="lesson5-core-question">
              <strong>Before you use an AI output, ask:</strong>
              <p>
      ...
      case 5:
        return (
          <>
            ...
            <h2>AI has rules — and you have responsibilities</h2>
            ...
            <div className="lesson5-law-layers">
              ...
              <article>
                <span>🏫</span>
                <strong>Institution rules</strong>
                <p>
              ...
              <article>
                <span>🤝</span>
                <strong>Responsible judgement</strong>
                <p>
            ...
            <div className="lesson5-responsibility-grid">
              <article>
                ...
                <ul>
                  <li>What you choose to enter.</li>
                  <li>What you choose to believe.</li>
                  <li>What you choose to share.</li>
                  <li>How you use the output.</li>
                  <li>Whether your use follows applicable rules.</li>
                </ul>
              </article>

              <article>
                <strong>AI is not your excuse.</strong>
                <p>
                  “The chatbot told me to do it” does not
                  remove the need for human judgement.
                </p>
                <p>
                  <b>AI is a tool. You make the decision.</b>
                </p>
              </article>
            </div>
      ...
      case 6:
        return (
          <>
            ...
            <h2>Scams, deepfakes and manipulation 🚨</h2>
            ...
            <div className="lesson5-threat-grid">
              ...
              <article>
                <span>🗣️</span>
                <strong>Voice impersonation</strong>
                <p>
            ...
            <div className="lesson5-red-flags">
              <strong>🚩 Common red flags</strong>

              <div>
                <span>“Act NOW!”</span>
                <span>“Keep this secret.”</span>
                <span>“Send the code.”</span>
                <span>“Don't verify.”</span>
                <span>“You must pay immediately.”</span>
              </div>
            </div>
            ...
            <div className="lesson5-emergency-rule">
              <span>🛑</span>
              <div>
                <strong>STOP → VERIFY → THEN ACT</strong>
                <p>
      ...
      case 7:
        return (
          <>
            ...
            <h2>Use AI responsibly in the real world</h2>
            ...
            <div className="lesson5-scenario-practice">
              {scenarioQuestions.map((scenario, index) => {
                ...
                const checked = checkedScenarios.includes(index);
                const correct = selected === scenario.answer;

                return (
                  <article key={scenario.situation}>
                    ...
                    <div>
                      ...
                      <div className="lesson5-safe-buttons">
                        <button
                          ...
                          onClick={() =>
                            chooseScenarioAnswer(index, "safe")
                          }
                        >
                          🟢 SAFE
                        </button>
                        ...
                        <button
                          ...
                          onClick={() =>
                            chooseScenarioAnswer(index, "unsafe")
                          }
                        >
                          🔴 UNSAFE
                        </button>
                      ...
                      <button
                        ...
                        disabled={!selected}
                        onClick={() => checkScenarioAnswer(index)}
                      >
                        {checked ? "Checked ✓" : "Check decision"}
                      </button>
          ...
          <>
            ...
            <div className="lesson5-final-list">
              {safetyQuestions.map((question, index) => {
                ...
                const checked = checkedFinal.includes(index);
            ...
            <div className="lesson5-score-card">
              ...
              <div className="lesson5-score-track">
                <div
                  style={{
                    width: `${
                      (finalScore / safetyQuestions.length) * 100
                    }%`,
                  }}
                />
              </div>
            ...
            <div className="lesson5-cheatsheet">
              ...
              >
                {showChecklist ? "Hide" : "Show"} my Safety
                Checklist
              </button>

              {showChecklist && (
                <div className="lesson5-checklist">
                  <h4>Before using AI, ask:</h4>
            ...
            {checkedFinal.length === safetyQuestions.length &&
              finalScore === safetyQuestions.length && (
                <div className="lesson5-complete-card">
                  ...
                  <div>
                    <strong>Lesson 5 completed!</strong>
                    <p>
                    ...
                    <small>
                      Your course progress is now 5 / 8.
                    </small>
                  </div>
      ...
      <div className="lesson5-layout">
        ...
        <main className="lesson5-content">
          ...
          <section className="lesson5-shortcuts-card">
            ...
            <h3>Safe prompting shortcuts</h3>
